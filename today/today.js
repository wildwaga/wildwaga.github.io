...
var headerTxt = ['HERE IS TODAY','HERE IS THIS MONTH','HERE IS THIS YEAR','HERE IS THIS CENTURY','HERE IS THIS MILLENNIUM','HERE IS THIS EPOCH','HERE IS THIS PERIOD','HERE IS THIS ERA','HERE IS THIS EON','HERE IS THE EARTH','HERE IS LIFE','HERE IS OXIDATION','HERE ARE FISH','HERE ARE INSECTS','HERE ARE REPTILES','HERE ARE MAMMALS','HERE ARE BIRDS','HERE ARE HUMANS','HERE IS THE UNIVERSE',''];
var blurbTxt = [];

var frameFunction = [draw0,draw1,draw2,draw3,draw4,draw5,draw6,draw7,draw8,draw9,draw10,draw11,draw12,draw13,draw14,draw15,draw16,draw17,draw18];
...
function init() {
	...
	today = ""+days[thisDate.getDay()]+" "+thisDate.getDate()+", "+thisMonth;
	blurbTxt = [today,thisMonth,thisYear,'21st Century', '3rd Millennium', 'Holocene - the current epoch of the geologic time scale','Quaternary - the current period of the geologic time scale','Cenozoic - the current era of the geologic time scale','Phanerozoic - the current eon of the geologic time scale','A volatile formation about 4.6 billion years ago','Simple cell life forms appeared about 3.6 billion years ago','Photosynthesis generates an oxygen atmosphere','Fish and proto-amphibians start to fill the waters','Insects and vegetation start to flourish','Reptiles rise from the water and dominate the land','Small mammals appear alongside the dinosaurs','Early birds evolve in the Jurassic period','Homo sapiens reaches anatomical modernity','...','','',''];
